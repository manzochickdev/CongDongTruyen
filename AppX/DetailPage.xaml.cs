...
namespace AppX
{
    ...
    public sealed partial class DetailPage : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            imgClone.Source = imgMain.Source;
        ...
        {
            imgClone.Width = e.NewSize.Width / 3;
            imgMain.Width = e.NewSize.Width / 3;
            if (e.NewSize.Width < 800)
            {

                gridContent.SetValue(Grid.RowSpanProperty, 1);
                gridContent.SetValue(Grid.RowProperty, 1);
                btnContent.Visibility = Visibility.Visible;
                tblSum.Visibility = Visibility.Collapsed;
            }
            else
            {
                gridContent.SetValue(Grid.RowSpanProperty, 2);
                gridContent.SetValue(Grid.RowProperty, 0);
                btnContent.Visibility = Visibility.Collapsed;
                tblSum.Visibility = Visibility.Visible;
            }
        }

        private void btnContent_Click(object sender, RoutedEventArgs e)
        {
            MessageDialog md = new MessageDialog(tblSum.Text);
            md.ShowAsync();
        }
    }
}
